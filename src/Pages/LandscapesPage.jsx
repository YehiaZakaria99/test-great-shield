        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-24 px-4 text-center">
            ...
            >
              ...
              tempora quod ad harum omnis odio nulla quasi eum laborum optio
              error, temporibus, voluptatibus distinctio sint natus assumenda
              labore possimus quo?
            </p>
          </section>
          <section className="space-y-28 overflow-hidden">
            {landscapes.map((landscape, index) => (
              <LandscapesPageCard key={index} landscape = {landscape} index={index} />
            ))}
          </section>
        </div>
      </section>
