      ...
      <div className="bg-[#111] min-h-screen flex items-center justify-center py-20 px-4">
        <section className="productDetails w-full max-w-7xl" data-aos="fade-up">
          <div className="box flex gap-6 flex-wrap md:flex-nowrap bg-navBg rounded-2xl p-6 shadow-lg shadow-black/30">
            ...
            {/* Content */}
            <div className="w-full md:w-2/3 lg:w-3/4 space-y-4" data-aos="fade-left">
              <div className="my-4">
                ...
                <div className="details text-white py-4">
                  <p className="mb-2">
                    <span className="font-bold text-sky-400 capitalize">owner :</span>{" "}
                    {currentProject.owner}
                  </p>
                  <p className="mb-2">
                    <span className="font-bold text-sky-400 capitalize">consultant :</span>{" "}
                    {currentProject.consultant}
                  </p>
                  <p className="mb-2">
                    <span className="font-bold text-sky-400 capitalize">project description :</span>{" "}
                    {currentProject.fullDescription}
                  </p>
                  <div className="mb-2">
                    <span className="font-bold text-sky-400 capitalize">scope of work :</span>
  ...
  >
    ...
    >
      ...
      <Slider
        ref={sliderRef}
        {...settings}
        initialSlide={currentProject.images.findIndex((img) => img === currentImage)}
